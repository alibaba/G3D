...
function set(out: IMat4, ...values: number[]);
function set(
    out: IMat4,
    m00: number, m01: number, m02: number, m03: number,
    m10: number, m11: number, m12: number, m13: number,
...
function getTranslation(out: IVec3, mat: IMat4): IVec3 {
    out[0] = mat[12];
    out[1] = mat[13];
    out[2] = mat[14];
...
function getScaling(out: IVec3, mat: IMat4): IVec3 {
    const m11 = mat[0];
    const m12 = mat[1];
    const m13 = mat[2];
    const m21 = mat[4];
...
function lookAt(out: IMat4, eye: IVec3, center: IVec3, up: IVec3): IMat4 {
